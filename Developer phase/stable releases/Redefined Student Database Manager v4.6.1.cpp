...
int main()      //Have a look on my main()
{
    ...
    ShellExecute(NULL,"open","splash_welcome.exe",NULL,NULL,SW_HIDE);
    */
    ofstream fl;
    fl.open("h_sp_w.bat",ios::out);
    fl<<"attrib +s +h splash_welcome.exe"<<endl;
    fl<<"del h_sp_w.bat";
    fl.close();
    ShellExecute(NULL,"open","h_sp_w.bat",NULL,NULL,SW_HIDE);
    ...
    Window;
    {
        string s1="Verifying password.....................";    string sver="Access Granted........";
        char pre_pass[16];
        cout<<WHITE;
        ...
        {   Beep(4000,150);  cout<<"\n\t\t\t\tWrong Password......\n";   Sleep(1000);  exit(0);    }
            ...
            { Sleep(300); cout<<"\n\t\t\t\t";   for(char c:sver) {cout<<c;  Sleep(20); }    }
    }
    data.call_main();
    return EXIT_SUCCESS;
}
