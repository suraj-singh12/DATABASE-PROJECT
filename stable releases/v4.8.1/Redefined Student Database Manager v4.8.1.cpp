...
void student::about()
{
    ...
    char abt_str3a[200]="It Makes Use Of The AI(Artificial Intelligence)\ni.e. It Has Ability To Discard Wrong Inputs\nFully Secured & Encrypted\nIt Gives You Independent Access To Your Database\n";
...
void student::show_details()
{
    ...
    ///It is calculated as 0 i.e. function does not works well or call error
    /*
