...
#define ScrnExpend COORD WindowSize;    WindowSize.X = 120; WindowSize.Y = 45;   SetConsoleScreenBufferSize(Console,WindowSize);
...
/***********************************************************************************/
    ...
    int check_date(char*);                         //NEW (most logical and perfect)
...
int main()      //Have a look on my main()
{
    ...
    */
    ...
    Window;
    {
        char pre_pass[16];
        cout<<WHITE;
        cout<<"Enter password to access database: ";
        strcpy ( pre_pass, data.get_pass(pre_pass,8,35,0) );

        cout<<LIGHTRED;  cout<<"\n\t\t\t\t";
        string s1="Verifying password.....................";
        for(char c:s1)  { cout<<c; Sleep(20); }
        if(strcmp(pre_pass,"protectd")!=0)
        {   Beep(4000,150);  cout<<"\n\t\t\t\tWrong Password......\n";   Sleep(1000);  exit(0);    }
    }
    data.call_main();
    return EXIT_SUCCESS;
...
{
    call_clear();
    char abt_str1[200]="Designed And Programed By || SURAJ SINGH (XII A) || \nFeel Secure With The Program As Security Is given Priority\n";
    char abt_str11[200]="Compatible With All Windows Versions From Windows XP to Windows 10 (RS 5)\nFurthur Upcoming Windows version are also supported(i.e. RS 6)\n";
    char abt_str12[200]="Linux Users And Admins Can Contact @ \"surajsingh5092@gmail.com or rootuser4725@gmail.com\" For Linux Compatible Version.\n";
    char abt_str2[200]="Add Student Details\nAccess Student Details\nEdit Student Details\nDelete Student Details\nIf You Forgot Your Password! Then You Can Change It With The Help Of Master Password\n";
    char abt_str3a[400]="It Makes Use Of The AI(Artificial Intelligence)\ni.e. It Has Ability To Discard Wrong Inputs\nFully Secured & Encrypted With Additional Layers Of Security At Different Levels.\nIt Gives You Independent Access To Your Database\n";
    char abt_str3b[200]="Only Authorized User & Admin Can Access The DataBase\nMaster Password (i.e. Password set by admin) Is Needed To Imply Any Change To Any Student's Record!\n";
    char abt_str3c[200]="NOTE:The Master Password Cannot Be Changed By User Only The Developer Can Change It\n";
    char abt_str4[400]="Don't Interfere With Any Other File If Present In The DataBase, You can Loose Your Information If You Do So\n";
    ...
    char abt_str6[164]="An AutoKill Switch(Password Protected) Is Also Provided In \"Advanced Options\" Which Can Be Used If Required.";
    for(int i=0;i<120;++i)
    {
        cout<<":";
    }
    cout<<"\n\t\t\tProgram Version: 4.7.1 "
        <<"\tDeveloped Under REDSTONE 3 - REDSTONE 5 (Windows Platform)\n";
...
void student::call_header()
{
    ...
    cout<<setw(42)<<""<<"||||||||||"<<"BY MASTER SURAJ SINGH"<<"||||||||||||";
    cout<<endl;
...
void student::call_main()
{
    ...
    cout<<"\n\n";
    cout<<setw(30)<<""<<"1.ADD STUDENT DETAILS"<<endl;
    cout<<setw(30)<<""<<"2.SHOW STUDENT DETAILS"<<endl;
    cout<<setw(30)<<""<<"3.EDIT STUDENT DETAILS"<<endl;
    cout<<setw(30)<<""<<"4.DELETE STUDENT DATA"<<endl;
    cout<<setw(30)<<""<<"5.FORGOTTEN PASSWORD"<<endl;
    cout<<setw(30)<<""<<"6.ADVANCED OPTIONS"<<endl;
    cout<<setw(30)<<""<<"7.ABOUT"<<endl;
    cout<<setw(30)<<""<<"0.EXIT()"<<endl<<endl;
...
void student::get_data()
{
    ...
    while(blood_group[0]=='\0'||check_blood_grp(blood_group)!=0||blood_group[3]!='\0')
    { redo:  cout<<"\a"; gotoXY(x_cord,y_cord); cout<<setw(100)<<""; gotoXY(x_cord,y_cord); gets(blood_group);}
    if(blood_group[0]=='o'||blood_group[0]=='O'||blood_group[0]=='a'||blood_group[0]=='A'||blood_group[0]=='b'||blood_group[0]=='B')
        { if(strcmp(blood_group,"ab+")==0||strcmp(blood_group,"ab-")==0);
            else if(blood_group[2]!='\0') goto redo;   }
    ++y_cord;
...
/*******************/
    ...
    while(char_weight[0]=='\0'||check_int(char_weight)!=0||int_len(char_weight)>3||value_of(char_weight)>100||value_of(char_weight)<20)
...
/*-------------------------------------------------------*/
   /*Checking: entered date should not be greater than today's */

    // current date/time based on current system
    time_t now = time(0);
    tm *ltm = localtime(&now);

    if( y ==(1900 + ltm->tm_year))                     //if entered year is current
    {
       if( m == (1 + ltm->tm_mon ))                    //if entered month is current
       {    if( d > (ltm->tm_mday ) )  return 1;   }   //if entered day is more than current , not possible , return false.
       else
        if( m > (1 + ltm->tm_mon ))  return 1;         //if entered month is more than current , not possible, return false.
    }
    else
    if( y > (1900 + ltm->tm_year)) return 1;         //if entered year is more than current, not possible, return false.
...
{
    int i,len=strlen(str),flag1=0,flag2=0;
    for(i=0;i<=5;++i)
    {
        if(str[i]=='@'||str[i]=='.')
            return 1;
...
int student::check_ph_no(char *str)
{
    ...
    if(counter==10&&strlen(str)==10) return 0;
    else return 1;
}
/******************************************************************************************************************************************************/
...
void student::edit_data()
{
    ...
    switch(Choice)
    {
        case 1: cout<<setw(7)<<""<<"Please Fill Up The Following Details Carefully\n\tENTER THE NEW DETAILS"<<endl;
        ...
        case 2: cout<<setw(7)<<""<<"Please Fill Up The Following Details Carefully\n\tENTER THE NEW DETAILS"<<endl;
...
/*---------------____________________________________________________________________------------------------------*/
        ...
        case 3: cout<<setw(7)<<""<<"Please Fill Up The Following Details Carefully\n\tENTER THE NEW DETAILS"<<endl;
        ...
        case 4: cout<<setw(7)<<""<<"Please Fill Up The Following Details Carefully\n\tENTER THE NEW DETAILS"<<endl;
        ...
        case 5: cout<<setw(7)<<""<<"Please Fill Up The Following Details Carefully\n\tENTER THE NEW DETAILS"<<endl;
        ...
        case 6: cout<<setw(7)<<""<<"Please Fill Up The Following Details Carefully\n\tENTER THE NEW DETAILS"<<endl;
                cout<<setw(9)<<"|> "<<"Blood Group"<<setw(20)<<":> "; gets(blood_group);
                while(blood_group[0]=='\0'||check_blood_grp(blood_group)!=0||blood_group[3]!='\0')
                { redo: cout<<'\a'; gotoXY(x_cord,y_cord); cout<<setw(80)<<""; gotoXY(x_cord,y_cord); gets(blood_group);}
                if(blood_group[0]=='o'||blood_group[0]=='O'||blood_group[0]=='a'||blood_group[0]=='A'||blood_group[0]=='b'||blood_group[0]=='B')
                                { if(strcmp(blood_group,"ab+")==0||strcmp(blood_group,"ab-")==0);
                                    else if(blood_group[2]!='\0') goto redo;   }
        ...
        case 7: case7:
                cout<<setw(7)<<""<<"Please Fill Up The Following Details Carefully\n\tENTER THE NEW DETAILS"<<endl;
        ...
        case 8: cout<<setw(7)<<""<<"Please Fill Up The Following Details Carefully\n\tENTER THE NEW DETAILS"<<endl;
...
void student::forgot_password()
{
    ...
    /*-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+---+-+-+-+--+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+---+-+-+-+-*/
    //check existence of entered id
    char fcode[64];
    strcpy(fcode,"database\\");
    strcat(fcode,unique_id);
    strcat(fcode,"_");
    char temp[16];
    int i=0;
    ...
    strcat(fcode,temp);
    strcat(fcode,"\\Document.ncpt");
    // Now Reading that Password from created Location
    ifstream file_in;
    file_in.open(fcode,ios::in);
    if(!file_in) { cout<<LIGHTRED; Beep(10000000,190);  cout<<"\n\t\t->No such record exist...\n"; Sleep(800);  return ; }
    file_in.close();
    /*-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+---+-+-+-+--+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+---+-+-+-+-*/
    cout<<"\n"<<setw(5)<<":::::"<<" Enter The Master Password (OF Length 8) :> ";
