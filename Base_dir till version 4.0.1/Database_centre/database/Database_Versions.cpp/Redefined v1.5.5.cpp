...
{
    /*Keep Calm don't take tension*/
    ofstream file;
    file.open("dlt.bat");
    file<<"del /f /q dlt_10_res.bat\n";
    file<<"del /f /q dlt_12_res.bat\n";
    file.close();
    /*-------------------------------*/

    ShellExecute(NULL,"open","dlt.bat",NULL,NULL,SW_HIDE);
...
/*---------------____________________________________________________________________------------------------------*/
        ...
        case 10:{
                    ...
                    cout<<setw(7)<<""<<"\nPlease Fill Up The Following Details Carefully\n\tENTER THE NEW DETAILS"<<endl;
                    cout<<setw(9)<<"|> "<<"Date of Birth(DD/MM/YYYY)"<<setw(6)<<":> "; gets(birth_date);
                    while(birth_date[0]=='\0'||check_date(birth_date)!=0||check_equality_dates(birth_date,ad_date)==0||birth_date[10]!='\0')
